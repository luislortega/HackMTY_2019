        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
              FlatButton(
                  onPressed: () => {Navigator.push(context, MaterialPageRoute(builder: (context)=>ListPlaces()))},
                  padding: EdgeInsets.all(10.0),
                  child: Column( // Replace with a Row for horizontal icon + text
                    children: <Widget>[
                      Image.asset("images/drag.png", width: 150.0, height: 50.0, ),
            ...
            Row(
              children: <Widget>[
                ...
                FlatButton(
                    ...
                    onPressed: ()=>{},
                    child: Text("¿Qué donar?", style: TextStyle(fontSize: 20, color: Colors.orange)),
                  ) ,
              ],
            )
          ],
